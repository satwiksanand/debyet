<?php
//establishing the connection with the help of db.php

session_start();
/*
? will have to use session_start(), if there is a need to show profile of the user.
! after login create a page that will show the profile of the user typically without the login and signup button.
*/
$_SESSION['flag']=false;
// unset($_SESSION['fn']);
// unset($_SESSION['ln']);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($num<=0) {
        ...
        <strong>Hmmm!</strong> you don't seem to have a account please sign up!
        <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
        </div>";
        
    } else {
        //will work here in a sec.
...
<body>
    ...
    <section id="login">
        <div class="container">
                ...
                <form action="/projects/blood_bank/index.php" method="post">
                    <input class="username" type="email" placeholder="Username" required name="email">
                    <input class="password" type="Password" placeholder="Password" required name="pass">
